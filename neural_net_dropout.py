# Single layer neural network with dropout.
import numpy
import math
...
def predict(dropout):
    ...
    if dropout:
        # Multiply drop out (80% keep) with output.
        dv = numpy.random.choice(2, size=(2, 4), p=[1-keep, keep])
        a1 = numpy.multiply(a1, dv) / keep
    # Layer two.
